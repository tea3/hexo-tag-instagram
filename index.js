...
hexo.extend.tag.register('instagram', function(args, content){
	...
	var returnHTML = "";
  	...
  	if(args[0] && args[0].match(/https\:\/\/www\.instagram\.com\/p\/[0-9a-zA-Z-_]+/)){

	  	var matchURL = args[0].match(/https\:\/\/www\.instagram\.com\/p\/([0-9a-zA-Z-_]+)/);
	  	postId = matchURL[1];
